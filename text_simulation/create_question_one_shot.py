...
def create_question_one_shot(input_file, output_dir):
    ...
    top_level_block_content_lines.append(format_instructions())
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", default="text_simulation/simulation_input_one_shot")
    ...
    for input_file in tqdm(input_files, desc="Creating input one shot"):
        create_question_one_shot(input_file, args.output_dir)